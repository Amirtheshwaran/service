...
The horror is focused on slow burn and atmosphere rather than cheap jump scares. In this build (v7), the first shift covers five locations across the county:
